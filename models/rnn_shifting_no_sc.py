...
mc = ModelCheckpoint('saved_model/rnn_shifting_s{}_k{}_no_sc.h5'.format(S, K), monitor='val_mae', mode='min', verbose=2, save_best_only=True)
...
saved_model = load_model('saved_model/rnn_shifting_s{}_k{}_no_sc.h5'.format(S, K))

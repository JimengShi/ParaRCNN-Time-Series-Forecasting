...
mc = ModelCheckpoint('saved_model/cnn1D_shifting_s{}_k{}_sc.h5'.format(S, K), monitor='val_mae', mode='min', verbose=2, save_best_only=True)
...
saved_model = load_model('saved_model/cnn1D_shifting_s{}_k{}_sc.h5'.format(S, K))
